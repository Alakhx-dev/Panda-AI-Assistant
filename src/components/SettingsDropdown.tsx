            ...
            <AnimatePresence>
                {open && (
                    <motion.div
                        ...
                        className="absolute right-0 top-12 z-50 w-72 rounded-xl card-glass shadow-2xl shadow-black/20 overflow-hidden"
                    >
                        {/* Header */}
                        ...
                        {tab === "main" && (
                            <div className="p-2">
                                <button
                                    ...
                                    className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-foreground hover:bg-white/5 transition-colors"
                                >
