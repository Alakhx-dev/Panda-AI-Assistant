...
const ChatWindow: React.FC<ChatWindowProps> = ({ messages, isLoading, theme, language }) => {
  ...
  return (
    <div ref={scrollRef} className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 sm:py-8 space-y-6 sm:space-y-8">      <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
